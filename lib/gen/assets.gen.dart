...
class $AssetsAnimationsGen {
  ...
  /// File path: assets/animations/congratulation.json
  String get congratulation => 'assets/animations/congratulation.json';

  /// File path: assets/animations/email.json
  String get email => 'assets/animations/email.json';

  /// File path: assets/animations/error.json
  String get error => 'assets/animations/error.json';

  /// File path: assets/animations/hp_error.json
  String get hpError => 'assets/animations/hp_error.json';
